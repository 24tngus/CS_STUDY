...
| 날짜 | 제목 | 발표자 | 강의 |
| ----- | ----- | ----- | ---- |
| 2023.08.28 | 운영체제와 컴퓨터시스템의 구조 | | 1 |
| 2023.08.28 | 인터럽트(interrupt) | | 2 |
| 2023.08.28 | 시스템콜(system call)과 modebit | | 3 |
| 2023.08.28 | 메모리계층(memory hierarchy) | | 4 |
| 2023.08.28 | 가상메모리와 스와핑, 페이지폴트 그리고 스레싱 | | 5 |
| 2023.08.28 | 페이지교체 알고리즘(FIFO, LRU, NUR, LFU) | | 6 |
| 2023.08.28 | 프로세스(process) vs 스레드(thread) | | 7 |
